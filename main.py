...
from models import PostBase, PostCreate, SignUpModel, SignInModel, UserModel
...
# User
@app.post('/api/v1/sign-up/', response_model=UserModel)
...
@app.get('/api/v1/user/detail/{user_id}/', response_model=UserModel)
...
def create_post_api(post_data: PostCreate, db: Session = Depends(get_db)):
